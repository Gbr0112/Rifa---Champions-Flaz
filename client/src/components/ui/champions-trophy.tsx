  ...
  return (
    <div className="relative inline-block mb-8">
      <div className="animate-trophy-glow">
        <div className="w-48 h-64 mx-auto shadow-2xl animate-float relative flex items-center justify-center">
          {/* Champions League Trophy SVG - sem fundo */}
          <svg 
            className="w-40 h-56 text-yellow-500 drop-shadow-2xl" 
            viewBox="0 0 120 160" 
            fill="currentColor"
          >
            {/* Trophy Base */}
      ...
      {/* Champions Text - Moved further down */}
